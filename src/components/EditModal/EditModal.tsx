...
const EditModal = ({ setIsEditModalOpen }: Props) => {
  ...
  return ReactDOM.createPortal(
    <>
      ...
      <div className={cx("modal")}>
        ...
        >
          <img src={closeIcon} alt="Close button" className="close-btn-icon" />
        </button>
        ...
        <div className="flex justify-end pt-14">
          ...
          <button type="submit" className={cx("submit-btn")} name="submit-btn">
            submit
          </button>
        </div>
      </div>
